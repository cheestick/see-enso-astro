...
export default [
  {
    heading: "СММ ВЕДЕННЯ  СОЦ. МЕРЕЖ ФОНДУ “БЛАГОМАЙ”",
    description:
  ...
  },
  {
    ...
    thumbUrl: "/images/cases/04.jpg",
    tags: ["Email маркетинг", "Таргет", "Дизайн"],
    link: "",
  },
  {
    heading: "ВЕДЕННЯ РОЗДІЛУ ПРОЄКТУ НА САЙТІ “СОС ДИТЯЧІ МІСТЕЧКА УКРАЇНА”",
    description:
